...
export const C = Object.freeze({
  ...
  success:token('color-success-text'),
  successAccent:token('color-success'),
  successLight:token('color-success-subtle'),
  successMid:token('color-success-border'),
  warn:token('color-warning-text'),
  warnAccent:token('color-warning'),
  warnLight:token('color-warning-subtle'),
  warnMid:token('color-warning-border'),
  danger:token('color-danger-text'),
  dangerAccent:token('color-danger'),
