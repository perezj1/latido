...
export const MOCK_DOCS = [
  { id:'d1', emoji:'📄', cat:'permisos',  title:'Tipos de permiso de residencia',       summary:'Diferencias entre L, B, C y G, y ventajas especiales si eres ciudadano UE.',  time:'8 min', level:'Básico',
  ...
  { id:'d6', emoji:'🇩🇪', cat:'educacion', title:'Dónde aprender alemán en Suiza', summary:'Las mejores escuelas, apps y cursos gratis o baratos para hispanohablantes.', time:'8 min', level:'Básico',
  ...
  { id:'d7', emoji:'👨‍👩‍👧', cat:'permisos', title:'Reagrupación familiar en Suiza', summary:'Cómo traer a tu pareja e hijos a Suiza. Diferencias entre ciudadanos UE y no UE.', time:'9 min', level:'Medio',
  ...
  { id:'d8', emoji:'💰', cat:'impuestos', title:'AHV/AVS: tu pensión y cómo funciona', summary:'Cotizaciones obligatorias, jubilación y cómo recuperar tu dinero si te vas.', time:'7 min', level:'Medio',
  ...
  { id:'d9', emoji:'🏠', cat:'vivienda', title:'Cómo encontrar piso en Suiza', summary:'Plataformas, el dossier que necesitas y errores comunes a evitar.', time:'8 min', level:'Básico',
  ...
  { id:'d10', emoji:'💼', cat:'trabajo', title:'Tus derechos laborales en Suiza', summary:'Vacaciones, despido, bajas por enfermedad y salario mínimo — todo lo que debes saber.', time:'9 min', level:'Básico',
  ...
  { id:'d11', emoji:'💸', cat:'banco', title:'Enviar dinero a España y Latinoamérica', summary:'SEPA para España (casi gratis) y las mejores remesas para Latinoamérica en 2024.', time:'5 min', level:'Básico',
  ...
  { id:'d13', emoji:'🚗', cat:'permisos', title:'Carnet de conducir en Suiza', summary:'Canje directo si eres de la UE, proceso completo si eres de Latinoamérica — todo explicado.', time:'10 min', level:'Medio',
  ...
  { id:'d14', emoji:'🏢', cat:'trabajo', title:'Empresas de trabajo temporal en Suiza', summary:'Cómo registrarte, qué agencias buscar y cómo conseguir tu primer trabajo en Suiza.', time:'9 min', level:'Básico',
  ...
  { id:'d12', emoji:'🎓', cat:'educacion', title:'Convalidar tu título universitario en Suiza', summary:'UE vs. Latinoamérica: quién tiene reconocimiento automático y quién debe tramitarlo.', time:'8 min', level:'Medio',
