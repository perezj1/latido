  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        success: {
          DEFAULT:'var(--latido-color-success-text)',
          accent:'var(--latido-color-success)',
          text:'var(--latido-color-success-text)',
          subtle:'var(--latido-color-success-subtle)',
          border:'var(--latido-color-success-border)',
        },
        warning: {
          DEFAULT:'var(--latido-color-warning-text)',
          accent:'var(--latido-color-warning)',
          text:'var(--latido-color-warning-text)',
          subtle:'var(--latido-color-warning-subtle)',
          border:'var(--latido-color-warning-border)',
        },
        danger: {
          DEFAULT:'var(--latido-color-danger-text)',
          accent:'var(--latido-color-danger)',
          text:'var(--latido-color-danger-text)',
